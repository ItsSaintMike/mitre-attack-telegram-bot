...
1. Малварь-аналитики — быстрый доступ к описаниям техник и их связи с вредоносным ПО
2. Специалисты SOC — оперативный поиск информации по инцидентам
3. Пентестеры — планирование атак на основе тактик MITRE ATT&CK
4. Исследователи — изучение поведения злоумышленников
5. Студенты — изучение фреймворка MITRE ATT&CK на практике
